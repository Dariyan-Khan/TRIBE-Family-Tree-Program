...
def enter_info(person,window1,option_num,textentry_fi,textentry_su,textentry_birth_dd,textentry_birth_mm,textentry_birth_yyyy,textentry_death_dd,textentry_death_mm,
        ...
        if option_num == "2":
            ...
            if need_change_m == True:
                ...
                fieldM = "'" + MotherID + "'"
                keyfieldM = "'" + pre_mother + "'"
                cursor.execute("UPDATE tblFamily SET MotherID =" + fieldM + "WHERE MotherID =" + keyfieldM)
...
def create_and_enter_form(title, option_num, person):
    ...
    Button(window1, text="Submit", width=6, command=lambda: [enter_info(person,window1,option_num,textentry_fi,textentry_su,textentry_birth_dd,textentry_birth_mm,textentry_birth_yyyy,textentry_death_dd,textentry_death_mm,textentry_death_yyyy,textentry_pob,tkvar,tkvar_m,tkvar_f)]).grid(row=22, column=0, sticky=W)
